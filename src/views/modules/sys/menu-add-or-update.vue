  ...
  export default {
    ...
    methods: {
      init (id) {
        ...
        this.$httpk({
          url: this.$httpk.adornUrl('/sys/menu/select'),
          method: 'get',
          ...
          if (!this.dataForm.id) {
            ...
            // 修改
            this.$httpk({
              url: this.$httpk.adornUrl(`/sys/menu/info/${this.dataForm.id}`),
              method: 'get',
              params: this.$httpk.adornParams()
            }).then(({data}) => {
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$httpk({
              url: this.$httpk.adornUrl(`/sys/menu/${!this.dataForm.id ? 'save' : 'update'}`),
              method: 'post',
