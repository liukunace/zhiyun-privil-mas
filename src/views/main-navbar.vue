  ...
  <nav class="site-navbar" :class="'site-navbar--' + navbarLayoutType">
    ...
    <div class="site-navbar__body clearfix">
      ...
      <el-menu class="site-navbar__menu site-navbar__menu--right" mode="horizontal">
        ...
        <el-submenu index="3" >
          <template slot="title">业务系统</template>
          <el-menu-item index="2-1" :class="'site-navbar-dropmenu--' + navbarLayoutType">
            <a href="http://mszhjs.ivtech.tech" target="_blank">马山土地投资</a>
          </el-menu-item>
        ...
        <el-menu-item class="site-navbar__avatar" index="3">
          <el-dropdown :show-timeout="0" placement="bottom">
            ...
            <el-dropdown-menu slot="dropdown" :class="'site-navbar-dropmenu--' + navbarLayoutType">
